...
class Log:
    ...
    def comment(self, msg: str): self._log(msg, "COMMENT", "cyan")
    def lineBreak(self, msg: str=""): self._log(msg, "", "cyan")
    def section(self, msg: str): self._log(msg, "SECTION", "white")
    def header(self, msg: str): self._log(msg, "HEADER", "white")

    def warning(self, msg: str): self._log(msg, "WARNING", "yellow")
    def error(self, msg: str): self._log(msg, "ERROR", "red")
    
    def downloading(self, msg: str): self._log(msg, "DOWNLOADING", "yellow")
    def preprocessing(self, msg: str): self._log(msg, "PREPROCESSING", "yellow")
    def training(self, msg: str): self._log(msg, "TRAINING", "magenta")
    def testing(self, msg: str): self._log(msg, "TESTING", "orange")
